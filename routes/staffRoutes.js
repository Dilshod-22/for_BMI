...
const NonTeachingStaff = require('../models/nonTeachingStaffModel.js')
const capitalize = require('../config/capitalize.js')
const Dashboard = require('../models/dashboardModel.js')
const NonTeachingStaffSalary = require('../models/nonTeachingStaffSalary.js')
const nonTeachingStaffAttendance = require('../models/nonTeachingStaffAttendance.js')
const TeacherSalary = require('../models/teacherSalaryModel.js')
